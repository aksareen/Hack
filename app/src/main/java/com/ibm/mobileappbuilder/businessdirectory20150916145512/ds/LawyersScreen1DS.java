...
public class LawyersScreen1DS extends AppNowDatasource<LawyersScreen1DSItem>{
    ...
    public void getItem(String id, final Listener<LawyersScreen1DSItem> listener) {
        if ("0".equals(id)) {
            NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/lawyersScreen1DS", "GET");
          ...
          NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/lawyersScreen1DS"+id, "GET");
    ...
    public void getItems(int pagenum, final Listener<List<LawyersScreen1DSItem>> listener) {
        ...
        NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/lawyersScreen1DS?skip="+skip+"&limit="+limit+"&conditions="+conditions+"&sort="+sort+"&select=null&populate=null", "GET");
    ...
    public void getUniqueValuesFor(String searchStr, final Listener<List<String>> listener) {
        String conditions = getConditions(searchOptions, getSearchableFields());
        NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/lawyersScreen1DS?distinct="+searchStr+"&conditions="+conditions, "GET");
    ...
    public void create(LawyersScreen1DSItem item, Listener<LawyersScreen1DSItem> listener) {
      NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/lawyersScreen1DS", "POST");
    ...
    public void updateItem(LawyersScreen1DSItem item, Listener<LawyersScreen1DSItem> listener) {
      NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/lawyersScreen1DS", "PUT");
    ...
    public void deleteItem(LawyersScreen1DSItem item, final Listener<LawyersScreen1DSItem> listener) {
        NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/lawyersScreen1DS", "DELETE");
