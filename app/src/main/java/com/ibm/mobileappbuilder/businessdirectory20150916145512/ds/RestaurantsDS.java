...
public class RestaurantsDS extends AppNowDatasource<RestaurantsDSItem>{
    ...
    public void getItem(String id, final Listener<RestaurantsDSItem> listener) {
        if ("0".equals(id)) {
            NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/restaurantsDS", "GET");
          ...
          NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/restaurantsDS"+id, "GET");
    ...
    public void getItems(int pagenum, final Listener<List<RestaurantsDSItem>> listener) {
        ...
        NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/restaurantsDS?skip="+skip+"&limit="+limit+"&conditions="+conditions+"&sort="+sort+"&select=null&populate=null", "GET");
    ...
    public void getUniqueValuesFor(String searchStr, final Listener<List<String>> listener) {
        String conditions = getConditions(searchOptions, getSearchableFields());
        NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/restaurantsDS?distinct="+searchStr+"&conditions="+conditions, "GET");
    ...
    public void create(RestaurantsDSItem item, Listener<RestaurantsDSItem> listener) {
      NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/restaurantsDS", "POST");
    ...
    public void updateItem(RestaurantsDSItem item, Listener<RestaurantsDSItem> listener) {
      NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/restaurantsDS", "PUT");
    ...
    public void deleteItem(RestaurantsDSItem item, final Listener<RestaurantsDSItem> listener) {
        NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/restaurantsDS", "DELETE");
