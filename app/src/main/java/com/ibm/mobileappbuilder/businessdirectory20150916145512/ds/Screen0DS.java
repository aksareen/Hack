...
public class Screen0DS extends AppNowDatasource<Screen0DSItem>{
    ...
    public void getItem(String id, final Listener<Screen0DSItem> listener) {
        if ("0".equals(id)) {
            NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/screen0DS", "GET");
          ...
          NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/screen0DS"+id, "GET");
    ...
    public void getItems(int pagenum, final Listener<List<Screen0DSItem>> listener) {
        ...
        NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/screen0DS?skip="+skip+"&limit="+limit+"&conditions="+conditions+"&sort="+sort+"&select=null&populate=null", "GET");
    ...
    public void getUniqueValuesFor(String searchStr, final Listener<List<String>> listener) {
        String conditions = getConditions(searchOptions, getSearchableFields());
        NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/screen0DS?distinct="+searchStr+"&conditions="+conditions, "GET");
    ...
    public void create(Screen0DSItem item, Listener<Screen0DSItem> listener) {
      NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/screen0DS", "POST");
    ...
    public void updateItem(Screen0DSItem item, Listener<Screen0DSItem> listener) {
      NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/screen0DS", "PUT");
    ...
    public void deleteItem(Screen0DSItem item, final Listener<Screen0DSItem> listener) {
        NetworkLoggerInjector.networkLogger().logRequest("https://ibm-pods.buildup.io/app/57ef6bac57acb00300066379/r/screen0DS", "DELETE");
